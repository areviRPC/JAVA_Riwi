...
public class LibroController {
        ...
        do {
            ...
            switch (aOption){
                ...
                case "7":
                    ...
                    break;
                case "8":
                    JOptionPane.showMessageDialog(null,"Volver al menu prncipal");
                    break;
                default:
    ...
    public static void searchByTitulo(){
        ...
        String idSearch = JOptionPane.showInputDialog(" Ingresa el titulo a buscar");
    ...
    public static void searchByID(){
        ...
        int idSearch = Integer.parseInt( JOptionPane.showInputDialog(" ingresa el ID del libro a buscar"));
        String Result="Resultados de la busqueda: \n ";
    ...
    public static void searchByAutor(){
        ...
        int idSearch =Integer.parseInt( JOptionPane.showInputDialog("ingresa el autor del libro a buscar"));
        String Result="Resultados de la busqueda: \n ";
