...
public class CoderModel implements CRUD {
    ...
    public boolean update(Object obj) {
        ...
        // 3 Variable para conocer el estado de la accion
        ...
        try {
            ...
            // crear la conexion entre JAVA y base de datos

            PreparedStatement objPrepare =  objConnection.prepareStatement(sql);

            // 6 asignar valores a los parametros del Query
            ...
            int totalRowAffected = objPrepare.executeUpdate(); // devuelve el numero de filas afetadas
            ...
            JOptionPane.showMessageDialog(null, e.getMessage());
        } finally { // Esto se hace se cierre la conexion o no
            ConfigDB.closeConnection();
        }
