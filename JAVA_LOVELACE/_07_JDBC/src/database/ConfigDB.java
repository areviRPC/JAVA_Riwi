...
public class ConfigDB {
    ...
    public  static  Connection openConnection(){
        ...
        try{
            ...
            String url = "jdbc:mysql://bpfnptigbzzflcbgu0d6-mysql.services.clever-cloud.com:3306/bpfnptigbzzflcbgu0d6";
            String user = "unj7d0n6rijx6pmg";
            String password = "nWPtzPbr1SS0JYP4RwwU";
